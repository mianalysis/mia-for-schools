...
export default function TextEntry(props: Props) {
    return (
        <input
            ...
            onKeyDown={(e) => { if (e.key === "Enter") sendParameter(props.parameter.moduleid, props.parameter.name, (e.target as HTMLInputElement).value, props.parameter.parentGroupName, props.parameter.groupCollectionNumber) }}
